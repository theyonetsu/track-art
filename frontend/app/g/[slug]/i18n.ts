...
const dict = {
  fr: {
    ...
    hdByPhotographer: 'Les fichiers HD vous seront remis par votre photographe.', downloadAll: 'Tout télécharger (.zip)', download: 'Télécharger',
  ...
  en: {
    ...
    hdByPhotographer: 'Your photographer will deliver the HD files.', downloadAll: 'Download all (.zip)', download: 'Download',
  ...
  es: {
    ...
    hdByPhotographer: 'Tu fotógrafo te entregará los archivos HD.', downloadAll: 'Descargar todo (.zip)', download: 'Descargar',
