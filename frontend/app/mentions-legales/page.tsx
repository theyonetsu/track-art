...
export default function Page() {
  return (
    <LegalPage eyebrow="Informations" title="Mentions légales">
      ...
      <p>Track.Art est édité par [RAISON SOCIALE OU NOM], [FORME JURIDIQUE], au capital de [CAPITAL], immatriculée sous le numéro [SIREN], dont le siège est situé [ADRESSE]. Directeur de la publication : [NOM]. Contact : contact@trak.art.</p>
      <h2>Hébergement</h2>
